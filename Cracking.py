...
"""%s
 ...
 - author      :  Hannan Ansari
 - facebook    : Abdul Hannan Ansari
 - whatsap     : +923221268197
                ...
                if pwx == '':
                    ...
                    def zona(zafi_=None): 
                        ...
                        if ind == '':
                            ...
                            print '\n %s[%s*%s] HANNAN %sOK%s SAVE IN  >%s hasil/OK-%s-%s-%s.txt'%(P,K,P,H,P,H,ha, op, ta);jeda(0.2)
                            print '%s [%s*%s] HANNAN %sCP %sSAVE IN> %shasil/CP-%s-%s-%s.txt'%(P,K,P,K,P,K,ha, op, ta);jeda(0.2)
